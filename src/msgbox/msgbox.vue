    ...
    <transition name="msgbox-bounce">
      <div class="mint-msgbox" v-show="value">
        ...
        <div class="mint-msgbox-btns">
          <div :class="[ cancelButtonClasses ]" v-show="showCancelButton" @click="handleAction('cancel')">{{ cancelButtonText }}</div>
          <div :class="[ confirmButtonClasses ]" v-show="showConfirmButton" @click="handleAction('confirm')">{{ confirmButtonText }}</div>
        </div>
      </div>
    </transition>
  </div>
